...
class TalentController extends TalentControllerBase{
    ...
    public function jobAction(){
        $service = new Talent\Application\Service\Work\QueryWorkingExperienceService($this->_talentWorkExperienceRepository());;
    ...
    public function editJobAction($jobHistoryId){
        $service = new QueryWorkingExperienceService($this->_talentWorkExperienceRepository());
