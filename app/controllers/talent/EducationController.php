...
class EducationController extends \TalentControllerBase{
    public function newAction(){
        $this->view->pick('talent/education/new');
    ...
    public function saveAction(){
        ...
        if(false === $response->getStatus()){
            ...
            return $this->forward('education/new');
        }
    ...
    public function editAction($educationId){
        $this->view->pick('talent/education/edit');
