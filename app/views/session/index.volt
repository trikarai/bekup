  ...
  <head>
    ...
    <link href="/bekup/public/css/login/style.css" rel="stylesheet">
    <link href="/bekup/public/css/ogin/style-responsive.css" rel="stylesheet">
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action=<?php echo $this->url->get('session/login'); ?> method="post">
    ...
    <script type="text/javascript" src="/bekup/public/login/jquery.backstretch.min.js"></script>
    <script>
