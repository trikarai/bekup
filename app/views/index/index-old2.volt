{{ content() }}
	...
	<!-- CSS main Page
	================================================== -->
	<link rel="stylesheet" href="/bekup/css/base.css">  
	<link rel="stylesheet" href="/bekup/css/main.css">
	<link rel="stylesheet" href="/bekup/css/vendor.css">
	
   <!-- script
   ================================================== -->
	<script src="/bekup/js/modernizr.js"></script>

  
</head>

<script type="text/javascript">document.write("<Bo"+"dy");</script> id="top">
   	...
   	<div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li class="highlight with-sep" style="font-weight:900;"><a href="/../bekup/register" title="">Register</a></li>
                    <li class="highlight with-sep" style="font-weight:900;"><a href="/../bekup/session" title="">Log In</a></li>					
				</ul>
			</nav>
   	...
   	<div class="intro-content">
   		<div class="row">
   			...
   			<div class="col-twelve">
				...
				<img class="img-responsive" src="/bekup/img/intro-bg1.png"></img>
   ...
   <!-- Java Script
   ================================================== --> 
   <script src="/bekup/public/js/jquery-1.11.3.min.js"></script>
   <script src="/bekup/public/js/jquery-migrate-1.2.1.min.js"></script>
   <script src="/bekup/public/js/plugins.js"></script>
   <script src="/bekup/public/js/main.js"></script>
