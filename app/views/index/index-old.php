...
<head>
   ...
   ================================================== -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
 	...
 	<!-- CSS
   ================================================== -->
   <link rel="stylesheet" href="<?php echo base_url();?>template/Lhander10/css/base.css">  
   <link rel="stylesheet" href="<?php echo base_url();?>template/Lhander10/css/main.css">
   <link rel="stylesheet" href="<?php echo base_url();?>template/Lhander10/css/vendor.css">
   <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
   <link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">   
   <!--<link rel="stylesheet" href="template/Lhander10/css/base.css">  
   <link rel="stylesheet" href="template/Lhander10/css/main.css">
   <link rel="stylesheet" href="template/Lhander10/css/vendor.css"> --> 

   <!-- script
   ================================================== -->
	<script src="<?php echo base_url();?>template/Lhander10/js/modernizr.js"></script>

   <!-- favicons
	================================================== -->
	<link rel="icon" type="image/png" href="<?php echo base_url();?>template/Lhander10/favicon.png">
...
<body id="top">
   	...
   	<div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
                    ...
                    <li class="highlight with-sep"><a href="<?php echo base_url('clogin'); ?>" title="">Log In</a></li>					
				</ul>
			</nav>
   ...
   <!-- Java Script
   ================================================== --> 
   <script src="<?php echo base_url();?>template/Lhander10/js/jquery-1.11.3.min.js"></script>
   <script src="<?php echo base_url();?>template/Lhander10/js/jquery-migrate-1.2.1.min.js"></script>
   <script src="<?php echo base_url();?>template/Lhander10/js/plugins.js"></script>
   <script src="<?php echo base_url();?>template/Lhander10/js/main.js"></script>
