...
{{ content() }}
    ...
    <section class="content-header">
      <h1>
        <a href="{{url('talent/job')}}" class="btn tomboladd"><i class="fa fa-reply" aria-hidden="true"></i> back</a> Talent
        <small>profile</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Add Job History</h3>
        </div>
        <div class="box-body">
            
       <div style="width:50%; margin:10px">
           <form action="{{url('talent/saveJob')}}" method="post">
