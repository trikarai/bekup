                ...
                <div class="card">
                    <div class="content-card">
                        ...
                        <div class="footer">
                            <hr />
                            <div class="stats">
                                <i class="fa fa-pencil-square"></i><a href="{{url('talent/profile/index')}}" class="info-a link link--kumya"> <span data-letters="Update Profile">Update Profile</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="content-card">
                        ...
                        <div class="footer">
                            <hr />
                            <div class="stats">
                                <i class="fa fa-search"></i><a href="{{url('team/dashboard/index')}}" class="info-a link link--kumya"><span data-letters="View Team Profile">View Team Profile</span></a>
                            </div>
                        </div>
                    </div>
                </div>
