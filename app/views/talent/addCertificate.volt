{{ content() }}
    ...
    <section class="content-header">
      <h1>
        <a href="{{url('talent/certificate')}}" class="btn tomboladd"><i class="fa fa-reply" aria-hidden="true"></i> back</a> Talent
        <small>profile</small>
      </h1>
      <ol class="breadcrumb">
        <li class="active"><a href="{{url('talent/index')}}>"><i class="fa fa-dashboard"></i> Profile</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div style="width:50%; margin:10px">
            <form action="<?php echo $this->url->get('talent/saveCertificate')?>" method="post">
