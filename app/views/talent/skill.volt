    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div align="right">
            <a href="{{url('talent/addSkill')}}" class="btn tomboladd"><i class="fa fa-plus"></i> Add Skill Set</a>
</div>
        ...
        <div class="box-body">
			...
			<div class="tab-pane" id="settings">
                ...
                <tbody>
                {%if(skillSetDTOs)%}
                    {%for row in skillSetDTOs%}
                <tr>
                <td data-title="Skill"> {{row.querySkillDTO().type()}}  -  {{row.querySkillDTO().name()}} </td>
                <td data-title="Score"> {{row.score()}} </td>
                        
                <td data-title="Action">
			<a href="{{url('talent/editSkill/')}}{{row.id()}}" class="btn tomboledit">Edit</a>
                        </td>
                        <td>
