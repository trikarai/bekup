...
<table id="table" class="table table-hover table-mc-light-blue">
                ...
                <td data-title="Operational Course"> <?php echo $row->startOperationalDate(); ?> - <?php echo $row->endOperationalDate(); ?></td>
                        <td data-title="Action">
							...
							<a href='<?php echo $this->url->get('courseclass/edit/'.$row->id().'/'.$subjectId);?>' class="btn">Edit</a>
                        </td>
                        <td>
                        	<a href='<?php echo $this->url->get('courseclass/remove/'.$row->id().'/'.$subjectId);?>' class="btn">Remove</a>
                        </td>
                    </tr>
					<?php $i++; ?>
                <?php endforeach?>
