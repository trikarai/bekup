...
<head>
	...
	<button type="button" style="border-radius: 0 !important;position: fixed;z-index: 99;" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-exclamation" aria-hidden="true"></i>Info : Registration Process</button><br/>
	  ...
	  <form style="margin-top:45px;" method="POST" action={{url('register/signupJourney')}} >	
		...
		<div class="row" style="margin-bottom: 35px;">
			...
			<div class="row">
				<a class="preregis" href="<?php echo $this->url->get('register/journeyDiloMember');?>"><i class="ion ion-compose"></i> Click Here if you have registered as DILo Member</a>				
			</div>
