...
<head>
	...
	<button type="button" style="border-radius: 0 !important;" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-exclamation" aria-hidden="true"></i>Info : Registration Process</button><br/>


	  <form method="POST" action={{url('register/signupStart')}} >	
      
        <h1 style="margin-top: 17px;font-weight: bold;">Bekup Start Registration</h1>
		...
		<div class="row" style="margin-bottom: 35px;">
			...
			<div class="row">
				<a class="preregis" href="<?php echo $this->url->get('register/startDiloMember');?>"><i class="ion ion-compose"></i> Click Here if you have registered as DILo Member</a>			
			</div>
