...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2017 at 08:07 AM
...
INSERT INTO `bkp_programme` (`id`, `name`, `operation_start_date`, `operation_end_date`, `registration_start_date`, `registration_end_date`, `is_removed`) VALUES
...
CREATE TABLE IF NOT EXISTS `bkp_team_idea` (
  `id` smallint(6) NOT NULL,
  `name` varchar(64) NOT NULL,
  `local_problem` varchar(256) NOT NULL,
  `global_trend_relation` varchar(256) NOT NULL,
  `applied_technology` varchar(256) NOT NULL,
  `ideal_final_result` varchar(256) NOT NULL,
  `value_contradiction` varchar(256) NOT NULL,
  `used_resource` varchar(256) NOT NULL,
  `is_removed` tinyint(1) NOT NULL,
  `superhero_id` char(36) NOT NULL COMMENT '(DC2Type:guid)',
  `initiator_id` char(36) NOT NULL COMMENT '(DC2Type:guid)',
...
--
-- Indexes for table `bkp_team_idea`
--
ALTER TABLE `bkp_team_idea`
