...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2017 at 05:10 AM
...
INSERT INTO `bkp_talent_education` (`id`, `talent_id`, `phase`, `institution`, `major`, `start_year`, `end_year`, `note`) VALUES
(0, '1972245b-0bb5-4d1a-9d04-d8a0bd231f2b', 'S3', 'UNPAD', 'Physics', 1990, 2012, '');
...
--
-- Indexes for table `bkp_city_class`
--
ALTER TABLE `bkp_city_class`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_city_team_class`
--
ALTER TABLE `bkp_city_team_class`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_class_student`
--
ALTER TABLE `bkp_class_student`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_course`
--
ALTER TABLE `bkp_course`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_course_class`
--
ALTER TABLE `bkp_course_class`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bkp_team_class`
--
ALTER TABLE `bkp_team_class`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_team_class_mapping`
--
ALTER TABLE `bkp_team_class_mapping`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bkp_team_class_track`
--
ALTER TABLE `bkp_team_class_track`
 ADD PRIMARY KEY (`id`);
